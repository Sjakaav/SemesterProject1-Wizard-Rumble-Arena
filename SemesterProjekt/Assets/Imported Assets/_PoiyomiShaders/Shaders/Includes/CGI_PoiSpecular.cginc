    ...
    POI_TEXTURE_NOSAMPLER(_ShiftTexture);
    ...
    POI_TEXTURE_NOSAMPLER(_ShiftTexture1);
    ...
    float3 calculateSpecular1(float4 albedo)
    {
        ...
        {
            half3 finalSpecular = 0;
            float4 specularMap = POI2D_SAMPLER_PAN(_SpecularMap1, _MainTex, poiMesh.uv[_SpecularMap1UV], _SpecularMap1Pan);
            ...
            half specularMask = POI2D_SAMPLER_PAN(_SpecularMask1, _MainTex, poiMesh.uv[_SpecularMask1UV], _SpecularMask1Pan).r;

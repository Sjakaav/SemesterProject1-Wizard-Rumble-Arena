    ...
    float flipBookMask;
        ...
        float applyFlipbookAlphaToShadow(float2 uv)
        {
            ...
            if(_FlipbookAlphaControlsFinalAlpha)
            {
                ...
                flipbookShadowAlpha = UNITY_SAMPLE_TEX2DARRAY(_FlipbookTexArray, float3(TRANSFORM_TEX(newUV, _FlipbookTexArray) + _Time.x * _FlipbookTexArrayPan, currentFrame)).a;

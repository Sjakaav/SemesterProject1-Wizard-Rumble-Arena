    ...
    float3 calculateEmission()
    {
        ...
        if(!_EmissionCenterOutEnabled)
        {
            ...
            float4 _Emissive_Tex_var = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiMesh.uv[_EmissionMapUV] * float2(uvmultiplier, 1), _EmissionMapPan);
    ...
    float3 calculateEmission1()
    {
        ...
        {
            float4 _Emissive_Tex_var1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiMesh.uv[_EmissionMap1UV], _EmissionMap1Pan);

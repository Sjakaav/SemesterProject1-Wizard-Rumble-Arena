Shader ".poiyomi/Patreon/Particle2/Outline Cutout"
{
    Properties
    {
        ...
        [Vector2]_BumpMapPan ("Normal Pan", Vector) = (0, 0, 0, 0)
        ...
        [Vector2]_DetailTexPan ("Detail Tex Pan", Vector) = (0, 0, 0, 0)
        _DetailTint ("Detail Tint", Color) = (1, 1, 1)
        [Normal]_DetailNormalMap ("Detail Normal", 2D) = "bump" { }
        [Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _DetailNormalMapUV ("Detail Normal UV#", Int) = 0
        _DetailNormalMapScale ("Detail Normal Intensity", Range(0, 10)) = 1
        [Vector2]_DetailNormalMapPan ("Detail Normal Pan", Vector) = (0, 0, 0, 0)
        ...
        [Toggle(_)]_ParticleLit ("Basic Lighting", Float) = 0
        [HDR]_ParticleColor ("Color & Alpha", Color) = (1, 1, 1, 1)
        _ParticleTexture ("Texture", 2D) = "white" { }
        [Toggle(_)]_ParticleRandomRotation ("Random Rotation", Float) = 0
        ...
        [Toggle(_)]_ColorOverLifetime ("Color Over Lifetime?", Float) = 0
        ...
        [Toggle(_)]_ParticleFlipParticlesGoingInward ("Flip Particles Going Inward", Float) = 0
        ...
        [Toggle(_)]_EnableParticleFlipbook("Enable Flipbook", Float) = 0
        ...
        [Toggle(_)]_ParticleRandomTimeOffset("Random Starting Frame?", Float) = 0

Shader ".poiyomi/Toon/Simple/Cutout"
{
    Properties
    {
        ...
        [HideInInspector] shader_master_label ("<color=#ff0000ff>❤</color> <color=#000000ff>Poiyomi Simple V6.0</color> <color=#ff0000ff>❤</color>", Float) = 0
        ...
        */
        ...
        [Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _LightingAOTexUV ("AO Map UV#", Int) = 0
        ...
        */
        ...
        [Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _EmissionMask1UV ("Emission Mask UV", Int) = 0
        [Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _EmissionMap1UV ("Emission UV#", Int) = 0
        ...
        [Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _FlipbookTexArrayUV ("Flipbook UV#", Int) = 0
        [TextureArray]_FlipbookTexArray ("Texture Array", 2DArray) = "" { }
        [Vector2]_FlipbookTexArrayPan ("Texture Panning", Vector) = (0, 0, 0, 0)

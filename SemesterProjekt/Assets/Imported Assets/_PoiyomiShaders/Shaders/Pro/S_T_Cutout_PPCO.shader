Shader ".poiyomi/Pro/Tessellation/Outlines Cutout"
{
    Properties
    {
        ...
        //[HideInInspector][Vector2]_ShiftTexturePan ("Panning", Vector) = (0, 0, 0, 0)
        //[HideInInspector][Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, DistortedUV1, 4)] _ShiftTextureUV ("UV", Int) = 0
        ...
        [Toggle(_)]_OutlineLit ("Enable Lighting", Float) = 1
        ...
        [HideInInspector][Toggle(_)]_DissolveInvertNoise ("Invert?", Float) = 0
        ...
        [HideInInspector][Toggle(_)]_DissolveInvertDetailNoise ("Invert?", Float) = 0
        ...
        [Toggle(_)]_VideoEnableVideoPlayer ("Enable Video Player", Float) = 0
        [Toggle(_)]_VideoPixelateToResolution ("Pixelate To Resolution", Float) = 0
        [Toggle(_)]_VideoRepeatVideoTexture ("Clamp To UV", Float) = 0
        ...
        [Toggle(_)]_VideoEnableDebug ("Enable Debug", Float) = 0
        ...
        [Toggle(_)]_IridescenceNormalToggle ("Custom Normals?", Float) = 0
        ...
        [Toggle(_)]_EnableVertexGlitch ("Enable Vertex Glitching", Float) = 0
        ...
        [Toggle(_)]_EnableScifiSpawnIn ("Enable Sci Fi Spawn", Float) = 0
        ...
        [Toggle(_)]_VoronoiEnableRandomCellColor ("Rando Cell Col", Float) = 0
        ...
        [Enum(Off, 0, On, 1)] _AlphaToMask ("Alpha To Mask", Float) = 1
